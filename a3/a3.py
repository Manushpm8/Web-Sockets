...
q = ""
while (q != "Q"):
    a3_fnx_inp.choice_command()
    z = input()
    if (z == "F"):
        # File System Input Statements
        a3_fnx_inp.file_input_command()
        n = input()
        x = n.strip().split()
        q = x[0]
        # Admin Mode
            ...
            # O Command: Opening the Profile
                ...
                if(p.is_file() == True and p.suffix == ".dsu"):
                    try:
                        ...
                        f = open(p, mode = "r")
                        print("File Opened")
                        a3_fnx_inp.E_command()
                        a3_fnx_inp.P_command()
                        m = input()
                        n = m.strip().split()
                        j = {}
                        for i in f:
    ...
    # This command adds and edits posts to the internet with new as well as existing user profiles.
        ...
        a3_fnx_inp.internet_input_command()
        srv = str(input("Server IP: "))
        port = 3021
        a3_fnx_inp.profile_input_command()
        js = ""
        pr = input()
        
        # Creates a New Profile With The DS Server
        if (pr == "N"):
        ...
        # Accesses An Existing Profile With The DS Server & Adds A Post
        elif (pr == "E"):
