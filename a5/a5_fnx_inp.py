...
def keyword_input_command():
    print("\nFeel free to use the following keywords in your post if necessary:-")
    print("Transcludes the current weather description: \"@weather\"")  
    print("Transcludes the top tracks of an artist: \"@lastfm\"") 
    print("No Keyword: No Command") 
